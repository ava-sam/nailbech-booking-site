    ...
    <section className="max-w-xl mx-auto px-6 py-16">
      ...
      <div className="space-y-8">
        <div className="bg-surface rounded-xl p-6">
          <h2 className="text-cream font-heading font-bold mb-3">Send your deposit</h2>
        ...
        <div className="bg-surface rounded-xl p-6">
          <h2 className="text-cream font-heading font-bold mb-3">Reach out directly</h2>
          <div className="space-y-2 text-cream text-sm">
        ...
        <div className="bg-surface rounded-xl p-6">
          <h2 className="text-cream font heading font-bold mb-3">Follow along</h2>
